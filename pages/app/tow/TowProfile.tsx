...
export default function TowProfile() {
  return (
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.card}>
          <View style={styles.detail}>
            ...
            <Text style={styles.value}>Peter Tower</Text>
          </View>
          ...
          <View style={styles.detail}>
            ...
            <Text style={styles.value}>billwilhonson@yahoo.com</Text>
          </View>

          <View style={styles.detail}>
            <Text style={styles.label}>Towing Station</Text>
            <Text style={styles.value}>Tow Me St. Louis</Text>
          </View>
