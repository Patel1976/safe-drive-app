...
const activities = [
  {
    id: "1",
    title: "1 Car broke down at Gros Piton",
    time: "25th Jan, 10:23 AM",
  },
  {
    id: "2",
    title: "2 Cars Totaled at Pigeon Island",
    time: "12th Jan, 10:02 AM",
  },
  {
    id: "3",
    title: "1 Car wrecked at Marigot Bay",
    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.profileCard}>
          <View>
            <Text style={styles.profileTitle}>Tow/Wrecker Dashboard</Text>
          </View>
          <View style={styles.profileDetails}>
            <Text style={styles.officerName}>Quick Tow Services | #W-7890</Text>
          </View>
        </View>
