...
export default function PoliceReportsList() {
    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.profileCard}>
          <View>
            <Text style={styles.profileTitle}>Recent Reports</Text>
          </View>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              onPress={() => navigation.navigate("PreliminaryReport", {status: item.status})}
