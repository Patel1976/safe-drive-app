...
export default function PoliceEMTReport() {
  ...
  const custodySteps = [
    ...
    {
      id: 3,
      title: "Patient Admitted in Hospital",
      time: status === "Completed" ? "03rd Jul 2025, 3:00 PM" : "Pending",
      icon: require("../../../assets/images/Police/patientAdmitted.png"),
    ...
    <View style={{ flex: 1, backgroundColor: Colors.white }}>
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.profileCard}>
          <View>
            <Text style={styles.profileTitle}>EMT Services Report</Text>
          </View>
        ...
        <View style={styles.detailCard}>
          ...
          <Text style={styles.value}>One Patient</Text>
          ...
          <Text style={styles.value}>International Hospital</Text>

          <Text style={styles.label}>Additional Notes</Text>
          <Text style={styles.value}>Picked up the patient when he was unconscious.</Text>
        </View>
