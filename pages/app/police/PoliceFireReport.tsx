...
export default function PoliceEMTReport() {
  ...
  const custodySteps = [
    ...
    },
    {
      ...
      icon: require("../../../assets/images/Police/reached.png"),
    ...
    },
    {
      ...
      icon: require("../../../assets/images/Police/fireExtinguished.png"),
    ...
    },
    {
      ...
      time: "Pending",
      icon: require("../../../assets/images/Police/siteSecured.png"),
      status: status === "Completed" ? "Completed" : "Pending",
    },
  ];
    ...
    <View style={{ flex: 1, backgroundColor: Colors.white }}>
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.profileCard}>
          <View>
            <Text style={styles.profileTitle}>Fire Services Report</Text>
          </View>
        ...
        <View style={styles.detailCard}>
          ...
          <Text style={styles.value}>Fire was extinguished in 2 vehicles.</Text>
        </View>
