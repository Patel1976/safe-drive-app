...
export default function FirePreliminaryReport() {
  ...
  const custodySteps = [
    ...
    {
      id: 4,
      title: "Site secured & hazards checked",
    ...
    <View style={{ flex: 1, backgroundColor: Colors.white }}>
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.profileCard}>
          <View>
            <Text style={styles.profileTitle}>Fire Details</Text>
          </View>
        ...
        <View style={styles.inputCard}>
          ...
          <Text style={styles.label}>Fire Station Name</Text>
          <TextInput style={styles.inputBox}>Vieux Fort</TextInput>
          ...
          <TextInput
            ...
            numberOfLines={4}
          >
            Fire was extinguished in 2 vehicles.
          </TextInput>
        </View>
