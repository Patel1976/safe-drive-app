...
export default function FireCasesList() {
                        ...
                        <TouchableOpacity
                            onPress={() => {
                                if (item.status === "Respond") {
                                    navigation.navigate("FireCaseDetail", {status: item.status});
                                } else if (item.status === "Accepted") {
                                    navigation.navigate("FirePreliminaryReport", {status: item.status});
                                }
                            }}
