...
export default function EMTPreliminaryReport() {
  ...
  const custodySteps = [
    ...
    },
    {
      ...
      time: "Today, 11: 00 AM",
      icon: require("../../../assets/images/Police/patientPicked.png"),
      status: status === "Pending" ? "Pending" : "Completed",
    },
    {
      id: 3,
      title: "Patient Reached Hospital",
      time: status === "Completed" ? "Today, 3:00 PM" : "Pending",
      icon: require("../../../assets/images/EMT/patientAdmitted.png"),
      status: status === "Completed" ? "Completed" : "Pending",
    },
    {
      id: 4,
      title: "Patient Discharged",
      time: status === "Completed" ? "Today, 6:00 PM" : "Pending",
      icon: require("../../../assets/images/Police/patientDischarged.png"),
      status: status === "Completed" ? "Completed" : "Pending",
    },
  ];
    ...
    <View style={{ flex: 1, backgroundColor: Colors.white }}>
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.profileCard}>
          ...
          <View style={styles.profileDetails}>
            <View style={styles.officerInfo}>
              ...
              <Text style={styles.officerName}>#E-2025-8742</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.detailCard}>
          <Text style={styles.label}>No. of Patients</Text>
          <Text style={styles.value}>One</Text>
        ...
        <View style={styles.inputCard}>
          ...
          <TextInput style={styles.inputBox}>International Hospital</TextInput>
          ...
          <TextInput
            ...
            numberOfLines={4}
          >
            Picked up the patient when he was unconscious.
          </TextInput>
        </View>
        ...
        <View style={styles.actionButton}>
          <TouchableOpacity style={styles.goBackBtn} onPress={() => navigation.navigate("EMTCasesList")}>
